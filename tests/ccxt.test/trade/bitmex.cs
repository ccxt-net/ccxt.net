    ...
    public partial class TradeApi
    {
        ...
        public async Task BitMEX()
        {
            ...
            if (String.IsNullOrEmpty(_api_key.secret_key) == false || XApiClient.TestXUnitMode == XUnitMode.UseJsonFile)
            {
                ...
                if (_fetch_my_order.supported || TestConfig.SupportedCheck)
                {
                ...
                if (XApiClient.TestXUnitMode != XUnitMode.UseExchangeServer)
                {
                    ...
                    if ((_limit_order.supported || TestConfig.SupportedCheck) && _limit_order.message.IndexOf("lack of balance") < 0)
                    {
                    ...
                    if ((_market_order.supported || TestConfig.SupportedCheck) && _market_order.message.IndexOf("lack of balance") < 0)
                    {
                ...
                if ((_cancel_order.supported || TestConfig.SupportedCheck) && _cancel_order.errorCode != ErrorCode.OrderNotFound)
                {
                ...
                if ((_cancel_orders.supported || TestConfig.SupportedCheck) && _cancel_orders.errorCode != ErrorCode.OrderNotFound)
                {
                ...
                if ((_cancel_all_orders.supported || TestConfig.SupportedCheck) && _cancel_all_orders.errorCode != ErrorCode.OrderNotFound)
                {
