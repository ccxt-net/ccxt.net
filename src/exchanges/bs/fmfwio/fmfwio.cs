...
namespace CCXT.NET.BS.fmfwio
{
    /// <summary>
    /// Fmfwio exchange
    /// </summary>
    public sealed class FmfwioClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Fmfwio exchange
        /// </summary>
        public override string DealerName { get; set; } = "Fmfwio";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public FmfwioClient(string division)
            : base(division)
        {
        }
        ...
        public FmfwioClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.fmfwio.com" },
                                { "private", "https://api.fmfwio.com" },
                                { "trade", "https://api.fmfwio.com" }
                            },
                            www = "https://www.fmfwio.com",
                            doc = new List<string>
                            {
                                "https://docs.fmfwio.com"
                            }
                        },
