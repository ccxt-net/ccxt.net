...
namespace CCXT.NET.Bequant
{
    ...
    /// Bequant exchange
    /// </summary>
    public sealed class BequantClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bequant exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bequant";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BequantClient(string division)
            : base(division)
        {
        }
        ...
        public BequantClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.bequant.com" },
                                { "private", "https://api.bequant.com" },
                                { "trade", "https://api.bequant.com" }
                            },
                            www = "https://www.bequant.com",
                            doc = new List<string>
                            {
                                "https://docs.bequant.com"
                            }
                        },
