...
namespace CCXT.NET.GLOBAL.coincatch
{
    /// <summary>
    /// Coincatch exchange
    /// </summary>
    public sealed class CoincatchClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Coincatch exchange
        /// </summary>
        public override string DealerName { get; set; } = "Coincatch";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CoincatchClient(string division)
            : base(division)
        {
        }
        ...
        public CoincatchClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.coincatch.com" }
                            },
                            www = "https://www.coincatch.com",
                            doc = new List<string>
                            {
                                "https://docs.coincatch.com"
                            }
                        },
