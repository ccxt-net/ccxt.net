...
namespace CCXT.NET.GLOBAL.p2b
{
    /// <summary>
    /// P2b exchange
    /// </summary>
    public sealed class P2bClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// P2b exchange
        /// </summary>
        public override string DealerName { get; set; } = "P2b";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public P2bClient(string division)
            : base(division)
        {
        }
        ...
        public P2bClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.p2b.com" },
                                { "private", "https://api.p2b.com" },
                                { "trade", "https://api.p2b.com" }
                            },
                            www = "https://www.p2b.com",
                            doc = new List<string>
                            {
                                "https://docs.p2b.com"
                            }
