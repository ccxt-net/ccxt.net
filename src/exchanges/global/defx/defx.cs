...
namespace CCXT.NET.GLOBAL.defx
{
    /// <summary>
    /// Defx exchange
    /// </summary>
    public sealed class DefxClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Defx exchange
        /// </summary>
        public override string DealerName { get; set; } = "Defx";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public DefxClient(string division)
            : base(division)
        {
        }
        ...
        public DefxClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.defx.com" }
                            },
                            www = "https://www.defx.com",
                            doc = new List<string>
                            {
                                "https://docs.defx.com"
                            }
