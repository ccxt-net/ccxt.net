...
namespace CCXT.NET.GLOBAL.tradeogre
{
    /// <summary>
    /// Tradeogre exchange
    /// </summary>
    public sealed class TradeogreClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Tradeogre exchange
        /// </summary>
        public override string DealerName { get; set; } = "Tradeogre";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public TradeogreClient(string division)
            : base(division)
        {
        }
        ...
        public TradeogreClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.tradeogre.com" },
                                { "private", "https://api.tradeogre.com" },
                                { "trade", "https://api.tradeogre.com" }
                            },
                            www = "https://www.tradeogre.com",
                            doc = new List<string>
                            {
                                "https://docs.tradeogre.com"
                            }
                        },
