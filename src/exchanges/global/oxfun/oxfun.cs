...
namespace CCXT.NET.GLOBAL.oxfun
{
    ...
    /// Oxfun exchange
    /// </summary>
    public sealed class OxfunClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Oxfun exchange
        /// </summary>
        public override string DealerName { get; set; } = "Oxfun";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public OxfunClient(string division)
            : base(division)
        {
        }
        ...
        public OxfunClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.oxfun.com" },
                                { "private", "https://api.oxfun.com" },
                                { "trade", "https://api.oxfun.com" }
                            },
                            www = "https://www.oxfun.com",
                            doc = new List<string>
                            {
                                "https://docs.oxfun.com"
                            }
                        },
