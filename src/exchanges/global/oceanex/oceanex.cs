...
namespace CCXT.NET.GLOBAL.oceanex
{
    /// <summary>
    /// Oceanex exchange
    /// </summary>
    public sealed class OceanexClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Oceanex exchange
        /// </summary>
        public override string DealerName { get; set; } = "Oceanex";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public OceanexClient(string division)
            : base(division)
        {
        }
        ...
        public OceanexClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.oceanex.com" },
                                { "private", "https://api.oceanex.com" },
                                { "trade", "https://api.oceanex.com" }
                            },
                            www = "https://www.oceanex.com",
                            doc = new List<string>
                            {
                                "https://docs.oceanex.com"
                            }
                        },
