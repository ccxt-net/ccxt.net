...
namespace CCXT.NET.GLOBAL.hollaex
{
    /// <summary>
    /// Hollaex exchange
    /// </summary>
    public sealed class HollaexClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Hollaex exchange
        /// </summary>
        public override string DealerName { get; set; } = "Hollaex";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public HollaexClient(string division)
            : base(division)
        {
        }
        ...
        public HollaexClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.hollaex.com" },
                                { "private", "https://api.hollaex.com" },
                                { "trade", "https://api.hollaex.com" }
                            },
                            www = "https://www.hollaex.com",
                            doc = new List<string>
                            {
