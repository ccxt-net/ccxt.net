...
namespace CCXT.NET.Zb.Public
{
    ...
    ///
    /// </summary>
    public class ZOrderBooks : CCXT.NET.Coin.Public.OrderBooks, IOrderBooks
    {
        /// <summary>
        ///
        /// </summary>
    ...
    ///
    /// </summary>
    public class ZOrderBook : CCXT.NET.Coin.Public.OrderBook, IOrderBook
    {
        /// <summary>
        ///
        /// </summary>
    ...
    ///
    /// </summary>
    public class ZOrderBookItem : CCXT.NET.Coin.Public.OrderBookItem, IOrderBookItem
    {
        /// <summary>
        ///
        /// </summary>
