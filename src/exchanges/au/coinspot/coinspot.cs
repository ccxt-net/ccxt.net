...
namespace CCXT.NET.AU.coinspot
{
    ...
    /// Coinspot exchange
    /// </summary>
    public sealed class CoinspotClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Coinspot exchange
        /// </summary>
        public override string DealerName { get; set; } = "Coinspot";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CoinspotClient(string division)
            : base(division)
        {
        }
        ...
        public CoinspotClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.coinspot.com" },
                                { "private", "https://api.coinspot.com" },
                                { "trade", "https://api.coinspot.com" }
                            },
                            www = "https://www.coinspot.com",
                            doc = new List<string>
                            {
                                "https://docs.coinspot.com"
                            }
                        },
