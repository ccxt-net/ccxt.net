...
namespace CCXT.NET.AU.btcmarkets
{
    /// <summary>
    /// Btcmarkets exchange
    /// </summary>
    public sealed class BtcmarketsClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Btcmarkets exchange
        /// </summary>
        public override string DealerName { get; set; } = "Btcmarkets";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BtcmarketsClient(string division)
            : base(division)
        {
        }
        ...
        public BtcmarketsClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.btcmarkets.com" },
                                { "private", "https://api.btcmarkets.com" },
                                { "trade", "https://api.btcmarkets.com" }
                            },
                            www = "https://www.btcmarkets.com",
                            doc = new List<string>
                            {
                                "https://docs.btcmarkets.com"
                            }
                        },
