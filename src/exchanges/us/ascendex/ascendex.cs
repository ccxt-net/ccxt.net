...
namespace CCXT.NET.US.ascendex
{
    /// <summary>
    /// Ascendex exchange
    /// </summary>
    public sealed class AscendexClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Ascendex exchange
        /// </summary>
        public override string DealerName { get; set; } = "Ascendex";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public AscendexClient(string division)
            : base(division)
        {
        }
        ...
        public AscendexClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.ascendex.com" },
                                { "private", "https://api.ascendex.com" },
                                { "trade", "https://api.ascendex.com" }
                            },
                            www = "https://www.ascendex.com",
                            doc = new List<string>
                            {
                                "https://docs.ascendex.com"
                            }
                        },
