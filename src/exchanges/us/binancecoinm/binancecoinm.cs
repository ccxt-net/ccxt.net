...
namespace CCXT.NET.US.binancecoinm
{
    ...
    /// </summary>
    public sealed class BinancecoinmClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Binancecoinm exchange
        /// </summary>
        public override string DealerName { get; set; } = "Binancecoinm";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BinancecoinmClient(string division)
            : base(division)
        {
        }
        ...
        public BinancecoinmClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.binancecoinm.com" },
                                { "private", "https://api.binancecoinm.com" },
                                { "trade", "https://api.binancecoinm.com" }
                            },
                            www = "https://www.binancecoinm.com",
                            doc = new List<string>
                            {
                                "https://docs.binancecoinm.com"
                            }
                        },
