...
namespace CCXT.NET.US.alpaca
{
    ...
    /// Alpaca exchange
    /// </summary>
    public sealed class AlpacaClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Alpaca exchange
        /// </summary>
        public override string DealerName { get; set; } = "Alpaca";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public AlpacaClient(string division)
            : base(division)
        {
        }
        ...
        public AlpacaClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.alpaca.com" },
                                { "private", "https://api.alpaca.com" },
                                { "trade", "https://api.alpaca.com" }
                            },
                            www = "https://www.alpaca.com",
                            doc = new List<string>
                            {
                                "https://docs.alpaca.com"
                            }
                        },
