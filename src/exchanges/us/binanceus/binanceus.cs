...
namespace CCXT.NET.BinanceUS
{
    ...
    /// Binanceus exchange
    /// </summary>
    public sealed class BinanceusClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Binanceus exchange
        /// </summary>
        public override string DealerName { get; set; } = "Binanceus";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BinanceusClient(string division)
            : base(division)
        {
        }
        ...
        public BinanceusClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.binanceus.com" },
                                { "private", "https://api.binanceus.com" },
                                { "trade", "https://api.binanceus.com" }
                            },
                            www = "https://www.binanceus.com",
                            doc = new List<string>
                            {
                                "https://docs.binanceus.com"
                            }
                        },
