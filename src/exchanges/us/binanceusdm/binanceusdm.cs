...
namespace CCXT.NET.US.binanceusdm
{
    /// <summary>
    /// Binanceusdm exchange
    /// </summary>
    public sealed class BinanceusdmClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Binanceusdm exchange
        /// </summary>
        public override string DealerName { get; set; } = "Binanceusdm";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BinanceusdmClient(string division)
            : base(division)
        {
        }
        ...
        public BinanceusdmClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.binanceusdm.com" },
                                { "private", "https://api.binanceusdm.com" },
                                { "trade", "https://api.binanceusdm.com" }
                            },
                            www = "https://www.binanceusdm.com",
                            doc = new List<string>
                            {
                                "https://docs.binanceusdm.com"
                            }
                        },
