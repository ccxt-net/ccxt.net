...
namespace CCXT.NET.US.coinbaseinternational
{
    /// <summary>
    /// Coinbaseinternational exchange
    /// </summary>
    public sealed class CoinbaseinternationalClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Coinbaseinternational exchange
        /// </summary>
        public override string DealerName { get; set; } = "Coinbaseinternational";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CoinbaseinternationalClient(string division)
            : base(division)
        {
        }
        ...
        public CoinbaseinternationalClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.coinbaseinternational.com" },
                                { "private", "https://api.coinbaseinternational.com" },
                                { "trade", "https://api.coinbaseinternational.com" }
                            },
                            www = "https://www.coinbaseinternational.com",
                            doc = new List<string>
                            {
                                "https://docs.coinbaseinternational.com"
                            }
                        },
