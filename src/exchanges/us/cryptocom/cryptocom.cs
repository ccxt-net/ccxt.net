...
namespace CCXT.NET.US.cryptocom
{
    /// <summary>
    /// Cryptocom exchange
    /// </summary>
    public sealed class CryptocomClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Cryptocom exchange
        /// </summary>
        public override string DealerName { get; set; } = "Cryptocom";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CryptocomClient(string division)
            : base(division)
        {
        }
        ...
        public CryptocomClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.cryptocom.com" },
                                { "private", "https://api.cryptocom.com" },
                                { "trade", "https://api.cryptocom.com" }
                            },
                            www = "https://www.cryptocom.com",
                            doc = new List<string>
                            {
                                "https://docs.cryptocom.com"
                            }
                        },
