...
namespace CCXT.NET.CoinbaseAdvanced
{
    ...
    /// </summary>
    public sealed class CoinbaseadvancedClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Coinbaseadvanced exchange
        /// </summary>
        public override string DealerName { get; set; } = "Coinbaseadvanced";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CoinbaseadvancedClient(string division)
            : base(division)
        {
        }
        ...
        public CoinbaseadvancedClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.coinbaseadvanced.com" },
                                { "private", "https://api.coinbaseadvanced.com" },
                                { "trade", "https://api.coinbaseadvanced.com" }
                            },
                            www = "https://www.coinbaseadvanced.com",
                            doc = new List<string>
                            {
                                "https://docs.coinbaseadvanced.com"
                            }
                        },
