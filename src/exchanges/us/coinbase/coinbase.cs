...
namespace CCXT.NET.US.coinbase
{
    /// <summary>
    /// Coinbase exchange
    /// </summary>
    public sealed class CoinbaseClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Coinbase exchange
        /// </summary>
        public override string DealerName { get; set; } = "Coinbase";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CoinbaseClient(string division)
            : base(division)
        {
        }
        ...
        public CoinbaseClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.coinbase.com" }
                            },
                            www = "https://www.coinbase.com",
                            doc = new List<string>
                            {
                                "https://docs.coinbase.com"
                            }
                        },
