...
namespace CCXT.NET.US.apex
{
    /// <summary>
    /// Apex exchange
    /// </summary>
    public sealed class ApexClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Apex exchange
        /// </summary>
        public override string DealerName { get; set; } = "Apex";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public ApexClient(string division)
            : base(division)
        {
        }
        ...
        public ApexClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.apex.com" },
                                { "private", "https://api.apex.com" },
                                { "trade", "https://api.apex.com" }
                            },
                            www = "https://www.apex.com",
                            doc = new List<string>
                            {
                                "https://docs.apex.com"
                            }
