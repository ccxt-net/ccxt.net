...
namespace CCXT.NET.US.vertex
{
    /// <summary>
    /// Vertex exchange
    /// </summary>
    public sealed class VertexClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Vertex exchange
        /// </summary>
        public override string DealerName { get; set; } = "Vertex";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public VertexClient(string division)
            : base(division)
        {
        }
        ...
        public VertexClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.vertex.com" },
                                { "private", "https://api.vertex.com" },
                                { "trade", "https://api.vertex.com" }
                            },
                            www = "https://www.vertex.com",
                            doc = new List<string>
                            {
                                "https://docs.vertex.com"
                            }
                        },
