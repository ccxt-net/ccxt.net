...
namespace CCXT.NET.US.paradex
{
    /// <summary>
    /// Paradex exchange
    /// </summary>
    public sealed class ParadexClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Paradex exchange
        /// </summary>
        public override string DealerName { get; set; } = "Paradex";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public ParadexClient(string division)
            : base(division)
        {
        }
        ...
        public ParadexClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.paradex.com" },
                                { "private", "https://api.paradex.com" },
                                { "trade", "https://api.paradex.com" }
                            },
                            www = "https://www.paradex.com",
                            doc = new List<string>
                            {
                                "https://docs.paradex.com"
                            }
                        },
