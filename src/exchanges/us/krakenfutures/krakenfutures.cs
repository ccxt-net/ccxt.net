...
namespace CCXT.NET.US.krakenfutures
{
    /// <summary>
    /// Krakenfutures exchange
    /// </summary>
    public sealed class KrakenfuturesClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Krakenfutures exchange
        /// </summary>
        public override string DealerName { get; set; } = "Krakenfutures";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public KrakenfuturesClient(string division)
            : base(division)
        {
        }
        ...
        public KrakenfuturesClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.krakenfutures.com" },
                                { "private", "https://api.krakenfutures.com" },
                                { "trade", "https://api.krakenfutures.com" }
                            },
                            www = "https://www.krakenfutures.com",
                            doc = new List<string>
                            {
                                "https://docs.krakenfutures.com"
                            }
                        },
