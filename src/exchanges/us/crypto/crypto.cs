...
namespace CCXT.NET.US.crypto
{
    /// <summary>
    /// Crypto exchange
    /// </summary>
    public sealed class CryptoClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Crypto exchange
        /// </summary>
        public override string DealerName { get; set; } = "Crypto";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CryptoClient(string division)
            : base(division)
        {
        }
        ...
        public CryptoClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.crypto.com" },
                                { "private", "https://api.crypto.com" },
                                { "trade", "https://api.crypto.com" }
                            },
                            www = "https://www.crypto.com",
                            doc = new List<string>
                            {
                                "https://docs.crypto.com"
                            }
                        },
