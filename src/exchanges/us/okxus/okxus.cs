...
namespace CCXT.NET.US.okxus
{
    /// <summary>
    /// Okxus exchange
    /// </summary>
    public sealed class OkxusClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Okxus exchange
        /// </summary>
        public override string DealerName { get; set; } = "Okxus";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public OkxusClient(string division)
            : base(division)
        {
        }
        ...
        public OkxusClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.okxus.com" },
                                { "private", "https://api.okxus.com" },
                                { "trade", "https://api.okxus.com" }
                            },
                            www = "https://www.okxus.com",
                            doc = new List<string>
                            {
                                "https://docs.okxus.com"
                            }
                        },
