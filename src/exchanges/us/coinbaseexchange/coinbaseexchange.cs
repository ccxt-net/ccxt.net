...
namespace CCXT.NET.US.coinbaseexchange
{
    /// <summary>
    /// Coinbaseexchange exchange
    /// </summary>
    public sealed class CoinbaseexchangeClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Coinbaseexchange exchange
        /// </summary>
        public override string DealerName { get; set; } = "Coinbaseexchange";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CoinbaseexchangeClient(string division)
            : base(division)
        {
        }
        ...
        public CoinbaseexchangeClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.coinbaseexchange.com" },
                                { "private", "https://api.coinbaseexchange.com" },
                                { "trade", "https://api.coinbaseexchange.com" }
                            },
                            www = "https://www.coinbaseexchange.com",
                            doc = new List<string>
                            {
                                "https://docs.coinbaseexchange.com"
                            }
                        },
