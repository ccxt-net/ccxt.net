...
namespace CCXT.NET.BR.foxbit
{
    ...
    /// Foxbit exchange
    /// </summary>
    public sealed class FoxbitClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Foxbit exchange
        /// </summary>
        public override string DealerName { get; set; } = "Foxbit";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public FoxbitClient(string division)
            : base(division)
        {
        }
        ...
        public FoxbitClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.foxbit.com" },
                                { "private", "https://api.foxbit.com" },
                                { "trade", "https://api.foxbit.com" }
                            },
                            www = "https://www.foxbit.com",
                            doc = new List<string>
                            {
                                "https://docs.foxbit.com"
                            }
                        },
