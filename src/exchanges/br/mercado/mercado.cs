...
namespace CCXT.NET.BR.mercado
{
    /// <summary>
    /// Mercado exchange
    /// </summary>
    public sealed class MercadoClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Mercado exchange
        /// </summary>
        public override string DealerName { get; set; } = "Mercado";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public MercadoClient(string division)
            : base(division)
        {
        }
        ...
        public MercadoClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.mercado.com" },
                                { "private", "https://api.mercado.com" },
                                { "trade", "https://api.mercado.com" }
                            },
                            www = "https://www.mercado.com",
                            doc = new List<string>
                            {
                                "https://docs.mercado.com"
                            }
                        },
