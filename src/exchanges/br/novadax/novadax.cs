...
namespace CCXT.NET.BR.novadax
{
    /// <summary>
    /// Novadax exchange
    /// </summary>
    public sealed class NovadaxClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Novadax exchange
        /// </summary>
        public override string DealerName { get; set; } = "Novadax";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public NovadaxClient(string division)
            : base(division)
        {
        }
        ...
        public NovadaxClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.novadax.com" }
                            },
                            www = "https://www.novadax.com",
                            doc = new List<string>
                            {
                                "https://docs.novadax.com"
                            }
                        },
