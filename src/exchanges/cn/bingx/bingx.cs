...
namespace CCXT.NET.CN.bingx
{
    ...
    /// Bingx exchange
    /// </summary>
    public sealed class BingxClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bingx exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bingx";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BingxClient(string division)
            : base(division)
        {
        }
        ...
        public BingxClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.bingx.com" },
                                { "private", "https://api.bingx.com" },
                                { "trade", "https://api.bingx.com" }
                            },
                            www = "https://www.bingx.com",
                            doc = new List<string>
                            {
                                "https://docs.bingx.com"
                            }
                        },
