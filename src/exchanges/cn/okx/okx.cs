...
namespace CCXT.NET.CN.okx
{
    /// <summary>
    /// Okx exchange
    /// </summary>
    public sealed class OkxClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Okx exchange
        /// </summary>
        public override string DealerName { get; set; } = "Okx";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public OkxClient(string division)
            : base(division)
        {
        }
        ...
        public OkxClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.okx.com" },
                                { "private", "https://api.okx.com" },
                                { "trade", "https://api.okx.com" }
                            },
