...
namespace CCXT.NET.CN.bitget
{
    /// <summary>
    /// Bitget exchange
    /// </summary>
    public sealed class BitgetClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bitget exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bitget";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BitgetClient(string division)
            : base(division)
        {
        }
        ...
        public BitgetClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.bitget.com" }
                            },
                            www = "https://www.bitget.com",
                            doc = new List<string>
                            {
                                "https://docs.bitget.com"
                            }
                        },
