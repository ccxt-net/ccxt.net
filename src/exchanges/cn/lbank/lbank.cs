...
namespace CCXT.NET.CN.lbank
{
    /// <summary>
    /// Lbank exchange
    /// </summary>
    public sealed class LbankClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Lbank exchange
        /// </summary>
        public override string DealerName { get; set; } = "Lbank";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public LbankClient(string division)
            : base(division)
        {
        }
        ...
        public LbankClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.lbank.com" },
                                { "private", "https://api.lbank.com" },
                                { "trade", "https://api.lbank.com" }
                            },
                            www = "https://www.lbank.com",
                            doc = new List<string>
                            {
                                "https://docs.lbank.com"
                            }
                        },
