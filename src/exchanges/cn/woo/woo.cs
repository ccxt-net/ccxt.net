...
namespace CCXT.NET.CN.woo
{
    /// <summary>
    /// Woo exchange
    /// </summary>
    public sealed class WooClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Woo exchange
        /// </summary>
        public override string DealerName { get; set; } = "Woo";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public WooClient(string division)
            : base(division)
        {
        }
        ...
        public WooClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.woo.com" },
                                { "private", "https://api.woo.com" },
                                { "trade", "https://api.woo.com" }
                            },
                            www = "https://www.woo.com",
                            doc = new List<string>
                            {
                                "https://docs.woo.com"
                            }
