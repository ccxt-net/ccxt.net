...
namespace CCXT.NET.CN.kucoinfutures
{
    /// <summary>
    /// Kucoinfutures exchange
    /// </summary>
    public sealed class KucoinfuturesClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Kucoinfutures exchange
        /// </summary>
        public override string DealerName { get; set; } = "Kucoinfutures";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public KucoinfuturesClient(string division)
            : base(division)
        {
        }
        ...
        public KucoinfuturesClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.kucoinfutures.com" },
                                { "private", "https://api.kucoinfutures.com" },
                                { "trade", "https://api.kucoinfutures.com" }
                            },
                            www = "https://www.kucoinfutures.com",
                            doc = new List<string>
                            {
                                "https://docs.kucoinfutures.com"
                            }
                        },
