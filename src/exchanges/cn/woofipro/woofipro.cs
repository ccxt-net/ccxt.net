...
namespace CCXT.NET.CN.woofipro
{
    /// <summary>
    /// Woofipro exchange
    /// </summary>
    public sealed class WoofiproClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Woofipro exchange
        /// </summary>
        public override string DealerName { get; set; } = "Woofipro";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public WoofiproClient(string division)
            : base(division)
        {
        }
        ...
        public WoofiproClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.woofipro.com" },
                                { "private", "https://api.woofipro.com" },
                                { "trade", "https://api.woofipro.com" }
                            },
                            www = "https://www.woofipro.com",
                            doc = new List<string>
                            {
                                "https://docs.woofipro.com"
                            }
                        },
