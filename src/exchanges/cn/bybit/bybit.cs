...
namespace CCXT.NET.CN.bybit
{
    /// <summary>
    /// Bybit exchange
    /// </summary>
    public sealed class BybitClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bybit exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bybit";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BybitClient(string division)
            : base(division)
        {
        }
        ...
        public BybitClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.bybit.com" }
                            },
                            www = "https://www.bybit.com",
                            doc = new List<string>
                            {
                                "https://docs.bybit.com"
                            }
                        },
