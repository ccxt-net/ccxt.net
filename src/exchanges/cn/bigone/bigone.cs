...
namespace CCXT.NET.CN.bigone
{
    ...
    /// Bigone exchange
    /// </summary>
    public sealed class BigoneClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bigone exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bigone";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BigoneClient(string division)
            : base(division)
        {
        }
        ...
        public BigoneClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.bigone.com" },
                                { "private", "https://api.bigone.com" },
                                { "trade", "https://api.bigone.com" }
                            },
                            www = "https://www.bigone.com",
                            doc = new List<string>
                            {
                                "https://docs.bigone.com"
                            }
                        },
