...
namespace CCXT.NET.CN.gate
{
    /// <summary>
    /// Gate exchange
    /// </summary>
    public sealed class GateClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Gate exchange
        /// </summary>
        public override string DealerName { get; set; } = "Gate";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public GateClient(string division)
            : base(division)
        {
        }
        ...
        public GateClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.gate.com" },
                                { "private", "https://api.gate.com" },
                                { "trade", "https://api.gate.com" }
                            },
                            www = "https://www.gate.com",
                            doc = new List<string>
                            {
                                "https://docs.gate.com"
                            }
