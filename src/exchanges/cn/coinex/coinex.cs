...
namespace CCXT.NET.Coinex
{
    ...
    /// Coinex exchange
    /// </summary>
    public sealed class CoinexClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Coinex exchange
        /// </summary>
        public override string DealerName { get; set; } = "Coinex";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CoinexClient(string division)
            : base(division)
        {
        }
        ...
        public CoinexClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.coinex.com" }
                            },
                            www = "https://www.coinex.com",
                            doc = new List<string>
                            {
                                "https://docs.coinex.com"
                            }
                        },
