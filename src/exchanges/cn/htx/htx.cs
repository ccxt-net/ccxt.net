...
namespace CCXT.NET.CN.htx
{
    /// <summary>
    /// Htx exchange
    /// </summary>
    public sealed class HtxClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Htx exchange
        /// </summary>
        public override string DealerName { get; set; } = "Htx";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public HtxClient(string division)
            : base(division)
        {
        }
        ...
        public HtxClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.htx.com" },
                                { "private", "https://api.htx.com" },
                                { "trade", "https://api.htx.com" }
                            },
                            www = "https://www.htx.com",
                            doc = new List<string>
                            {
                                "https://docs.htx.com"
                            }
