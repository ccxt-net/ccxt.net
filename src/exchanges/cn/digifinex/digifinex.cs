...
namespace CCXT.NET.CN.digifinex
{
    /// <summary>
    /// Digifinex exchange
    /// </summary>
    public sealed class DigifinexClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Digifinex exchange
        /// </summary>
        public override string DealerName { get; set; } = "Digifinex";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public DigifinexClient(string division)
            : base(division)
        {
        }
        ...
        public DigifinexClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.digifinex.com" },
                                { "private", "https://api.digifinex.com" },
                                { "trade", "https://api.digifinex.com" }
                            },
