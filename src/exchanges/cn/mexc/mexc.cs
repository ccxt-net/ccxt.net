...
namespace CCXT.NET.CN.mexc
{
    /// <summary>
    /// Mexc exchange
    /// </summary>
    public sealed class MexcClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Mexc exchange
        /// </summary>
        public override string DealerName { get; set; } = "Mexc";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public MexcClient(string division)
            : base(division)
        {
        }
        ...
        public MexcClient(string division, string connect_key, string secret_key)
