...
namespace CCXT.NET.CN.xt
{
    ...
    /// Xt exchange
    /// </summary>
    public sealed class XtClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Xt exchange
        /// </summary>
        public override string DealerName { get; set; } = "Xt";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public XtClient(string division)
            : base(division)
        {
        }
        ...
        public XtClient(string division, string connect_key, string secret_key)
