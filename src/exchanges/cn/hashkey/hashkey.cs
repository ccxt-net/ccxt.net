...
namespace CCXT.NET.CN.hashkey
{
    /// <summary>
    /// Hashkey exchange
    /// </summary>
    public sealed class HashkeyClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Hashkey exchange
        /// </summary>
        public override string DealerName { get; set; } = "Hashkey";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public HashkeyClient(string division)
            : base(division)
        {
        }
        ...
        public HashkeyClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.hashkey.com" }
                            },
                            www = "https://www.hashkey.com",
                            doc = new List<string>
                            {
                                "https://docs.hashkey.com"
                            }
                        },
