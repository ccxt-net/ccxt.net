...
namespace CCXT.NET.CN.hitbtc
{
    /// <summary>
    /// Hitbtc exchange
    /// </summary>
    public sealed class HitbtcClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Hitbtc exchange
        /// </summary>
        public override string DealerName { get; set; } = "Hitbtc";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public HitbtcClient(string division)
            : base(division)
        {
        }
        ...
        public HitbtcClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.hitbtc.com" }
                            },
                            www = "https://www.hitbtc.com",
                            doc = new List<string>
                            {
                                "https://docs.hitbtc.com"
                            }
                        },
