...
namespace CCXT.NET.CN.kucoin
{
    /// <summary>
    /// Kucoin exchange
    /// </summary>
    public sealed class KucoinClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Kucoin exchange
        /// </summary>
        public override string DealerName { get; set; } = "Kucoin";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public KucoinClient(string division)
            : base(division)
        {
        }
        ...
        public KucoinClient(string division, string connect_key, string secret_key)
