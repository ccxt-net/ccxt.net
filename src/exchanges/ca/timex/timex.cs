...
namespace CCXT.NET.CA.timex
{
    /// <summary>
    /// Timex exchange
    /// </summary>
    public sealed class TimexClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Timex exchange
        /// </summary>
        public override string DealerName { get; set; } = "Timex";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public TimexClient(string division)
            : base(division)
        {
        }
        ...
        public TimexClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.timex.com" },
                                { "private", "https://api.timex.com" },
                                { "trade", "https://api.timex.com" }
                            },
                            www = "https://www.timex.com",
                            doc = new List<string>
                            {
                                "https://docs.timex.com"
                            }
                        },
