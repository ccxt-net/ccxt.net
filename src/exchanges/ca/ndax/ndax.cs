...
namespace CCXT.NET.CA.ndax
{
    /// <summary>
    /// Ndax exchange
    /// </summary>
    public sealed class NdaxClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Ndax exchange
        /// </summary>
        public override string DealerName { get; set; } = "Ndax";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public NdaxClient(string division)
            : base(division)
        {
        }
        ...
        public NdaxClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.ndax.com" },
                                { "private", "https://api.ndax.com" },
                                { "trade", "https://api.ndax.com" }
                            },
                            www = "https://www.ndax.com",
                            doc = new List<string>
                            {
                                "https://docs.ndax.com"
                            }
