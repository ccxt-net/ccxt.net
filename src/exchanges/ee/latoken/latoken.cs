...
namespace CCXT.NET.EE.latoken
{
    ...
    /// Latoken exchange
    /// </summary>
    public sealed class LatokenClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Latoken exchange
        /// </summary>
        public override string DealerName { get; set; } = "Latoken";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public LatokenClient(string division)
            : base(division)
        {
        }
        ...
        public LatokenClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.latoken.com" },
                                { "private", "https://api.latoken.com" },
                                { "trade", "https://api.latoken.com" }
                            },
