...
namespace CCXT.NET.KY.blofin
{
    /// <summary>
    /// Blofin exchange
    /// </summary>
    public sealed class BlofinClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Blofin exchange
        /// </summary>
        public override string DealerName { get; set; } = "Blofin";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BlofinClient(string division)
            : base(division)
        {
        }
        ...
        public BlofinClient(string division, string connect_key, string secret_key)
