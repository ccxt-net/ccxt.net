...
namespace CCXT.NET.KY.bitmart
{
    /// <summary>
    /// Bitmart exchange
    /// </summary>
    public sealed class BitmartClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bitmart exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bitmart";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BitmartClient(string division)
            : base(division)
        {
        }
        ...
        public BitmartClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.bitmart.com" },
                                { "private", "https://api.bitmart.com" },
                                { "trade", "https://api.bitmart.com" }
                            },
                            www = "https://www.bitmart.com",
                            doc = new List<string>
                            {
                                "https://docs.bitmart.com"
                            }
                        },
