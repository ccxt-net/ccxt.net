...
namespace CCXT.NET.MX.bitso
{
    /// <summary>
    /// Bitso exchange
    /// </summary>
    public sealed class BitsoClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bitso exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bitso";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BitsoClient(string division)
            : base(division)
        {
        }
        ...
        public BitsoClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.bitso.com" }
                            },
                            www = "https://www.bitso.com",
                            doc = new List<string>
                            {
