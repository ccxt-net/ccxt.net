...
namespace CCXT.NET.AE.deribit
{
    ...
    public sealed class DeribitClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        ...
        /// Deribit exchange
        /// </summary>
        public override string DealerName { get; set; } = "Deribit";
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.deribit.com" },
                                { "private", "https://api.deribit.com" },
                                { "trade", "https://api.deribit.com" }
                            },
