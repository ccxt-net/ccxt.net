...
namespace CCXT.NET.KR.probit
{
    /// <summary>
    /// Probit exchange
    /// </summary>
    public sealed class ProbitClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Probit exchange
        /// </summary>
        public override string DealerName { get; set; } = "Probit";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public ProbitClient(string division)
            : base(division)
        {
        }
        ...
        public ProbitClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.probit.com" }
                            },
                            www = "https://www.probit.com",
                            doc = new List<string>
                            {
                                "https://docs.probit.com"
                            }
                        },
