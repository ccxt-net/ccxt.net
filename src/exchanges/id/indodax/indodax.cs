...
namespace CCXT.NET.ID.indodax
{
    ...
    /// Indodax exchange
    /// </summary>
    public sealed class IndodaxClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Indodax exchange
        /// </summary>
        public override string DealerName { get; set; } = "Indodax";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public IndodaxClient(string division)
            : base(division)
        {
        }
        ...
        public IndodaxClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.indodax.com" },
                                { "private", "https://api.indodax.com" },
                                { "trade", "https://api.indodax.com" }
                            },
                            www = "https://www.indodax.com",
                            doc = new List<string>
                            {
                                "https://docs.indodax.com"
                            }
                        },
