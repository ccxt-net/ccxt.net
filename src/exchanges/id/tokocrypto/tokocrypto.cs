...
namespace CCXT.NET.ID.tokocrypto
{
    ...
    /// Tokocrypto exchange
    /// </summary>
    public sealed class TokocryptoClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Tokocrypto exchange
        /// </summary>
        public override string DealerName { get; set; } = "Tokocrypto";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public TokocryptoClient(string division)
            : base(division)
        {
        }
        ...
        public TokocryptoClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.tokocrypto.com" }
                            },
                            www = "https://www.tokocrypto.com",
                            doc = new List<string>
                            {
                                "https://docs.tokocrypto.com"
                            }
                        },
