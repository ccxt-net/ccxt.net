...
namespace CCXT.NET.GB.coinmetro
{
    /// <summary>
    /// Coinmetro exchange
    /// </summary>
    public sealed class CoinmetroClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Coinmetro exchange
        /// </summary>
        public override string DealerName { get; set; } = "Coinmetro";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CoinmetroClient(string division)
            : base(division)
        {
        }
        ...
        public CoinmetroClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.coinmetro.com" }
                            },
                            www = "https://www.coinmetro.com",
                            doc = new List<string>
                            {
                                "https://docs.coinmetro.com"
                            }
                        },
