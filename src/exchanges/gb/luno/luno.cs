...
namespace CCXT.NET.GB.luno
{
    /// <summary>
    /// Luno exchange
    /// </summary>
    public sealed class LunoClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Luno exchange
        /// </summary>
        public override string DealerName { get; set; } = "Luno";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public LunoClient(string division)
            : base(division)
        {
        }
        ...
        public LunoClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.luno.com" },
                                { "private", "https://api.luno.com" },
                                { "trade", "https://api.luno.com" }
                            },
