...
namespace CCXT.NET.GB.blockchaincom
{
    /// <summary>
    /// Blockchaincom exchange
    /// </summary>
    public sealed class BlockchaincomClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Blockchaincom exchange
        /// </summary>
        public override string DealerName { get; set; } = "Blockchaincom";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BlockchaincomClient(string division)
            : base(division)
        {
        }
        ...
        public BlockchaincomClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.blockchaincom.com" },
                                { "private", "https://api.blockchaincom.com" },
                                { "trade", "https://api.blockchaincom.com" }
                            },
                            www = "https://www.blockchaincom.com",
                            doc = new List<string>
                            {
                                "https://docs.blockchaincom.com"
                            }
                        },
