...
namespace CCXT.NET.GB.bitteam
{
    /// <summary>
    /// Bitteam exchange
    /// </summary>
    public sealed class BitteamClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bitteam exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bitteam";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BitteamClient(string division)
            : base(division)
        {
        }
        ...
        public BitteamClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.bitteam.com" },
                                { "private", "https://api.bitteam.com" },
                                { "trade", "https://api.bitteam.com" }
                            },
                            www = "https://www.bitteam.com",
                            doc = new List<string>
                            {
                                "https://docs.bitteam.com"
                            }
                        },
