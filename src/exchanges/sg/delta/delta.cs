...
namespace CCXT.NET.SG.delta
{
    /// <summary>
    /// Delta exchange
    /// </summary>
    public sealed class DeltaClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Delta exchange
        /// </summary>
        public override string DealerName { get; set; } = "Delta";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public DeltaClient(string division)
            : base(division)
        {
        }
        ...
        public DeltaClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.delta.com" },
                                { "private", "https://api.delta.com" },
                                { "trade", "https://api.delta.com" }
                            },
                            www = "https://www.delta.com",
                            doc = new List<string>
                            {
                                "https://docs.delta.com"
                            }
                        },
