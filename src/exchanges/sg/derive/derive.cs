...
namespace CCXT.NET.SG.derive
{
    /// <summary>
    /// Derive exchange
    /// </summary>
    public sealed class DeriveClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Derive exchange
        /// </summary>
        public override string DealerName { get; set; } = "Derive";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public DeriveClient(string division)
            : base(division)
        {
        }
        ...
        public DeriveClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.derive.com" },
                                { "private", "https://api.derive.com" },
                                { "trade", "https://api.derive.com" }
                            },
                            www = "https://www.derive.com",
                            doc = new List<string>
                            {
                                "https://docs.derive.com"
                            }
                        },
