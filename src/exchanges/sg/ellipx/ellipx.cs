...
namespace CCXT.NET.SG.ellipx
{
    /// <summary>
    /// Ellipx exchange
    /// </summary>
    public sealed class EllipxClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Ellipx exchange
        /// </summary>
        public override string DealerName { get; set; } = "Ellipx";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public EllipxClient(string division)
            : base(division)
        {
        }
        ...
        public EllipxClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.ellipx.com" },
                                { "private", "https://api.ellipx.com" },
                                { "trade", "https://api.ellipx.com" }
                            },
                            www = "https://www.ellipx.com",
                            doc = new List<string>
                            {
                                "https://docs.ellipx.com"
                            }
                        },
