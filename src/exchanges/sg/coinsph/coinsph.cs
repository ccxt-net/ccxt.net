...
namespace CCXT.NET.SG.coinsph
{
    /// <summary>
    /// Coinsph exchange
    /// </summary>
    public sealed class CoinsphClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Coinsph exchange
        /// </summary>
        public override string DealerName { get; set; } = "Coinsph";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CoinsphClient(string division)
            : base(division)
        {
        }
        ...
        public CoinsphClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.coinsph.com" },
                                { "private", "https://api.coinsph.com" },
                                { "trade", "https://api.coinsph.com" }
                            },
                            www = "https://www.coinsph.com",
                            doc = new List<string>
                            {
                                "https://docs.coinsph.com"
                            }
                        },
