...
namespace CCXT.NET.SG.hibachi
{
    /// <summary>
    /// Hibachi exchange
    /// </summary>
    public sealed class HibachiClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Hibachi exchange
        /// </summary>
        public override string DealerName { get; set; } = "Hibachi";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public HibachiClient(string division)
            : base(division)
        {
        }
        ...
        public HibachiClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.hibachi.com" },
                                { "private", "https://api.hibachi.com" },
                                { "trade", "https://api.hibachi.com" }
                            },
                            www = "https://www.hibachi.com",
                            doc = new List<string>
                            {
                                "https://docs.hibachi.com"
                            }
                        },
