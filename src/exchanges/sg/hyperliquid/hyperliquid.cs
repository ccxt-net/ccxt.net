...
namespace CCXT.NET.SG.hyperliquid
{
    /// <summary>
    /// Hyperliquid exchange
    /// </summary>
    public sealed class HyperliquidClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Hyperliquid exchange
        /// </summary>
        public override string DealerName { get; set; } = "Hyperliquid";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public HyperliquidClient(string division)
            : base(division)
        {
        }
        ...
        public HyperliquidClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.hyperliquid.com" },
                                { "private", "https://api.hyperliquid.com" },
                                { "trade", "https://api.hyperliquid.com" }
                            },
                            www = "https://www.hyperliquid.com",
                            doc = new List<string>
                            {
                                "https://docs.hyperliquid.com"
                            }
                        },
