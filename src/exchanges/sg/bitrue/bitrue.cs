...
namespace CCXT.NET.SG.bitrue
{
    /// <summary>
    /// Bitrue exchange
    /// </summary>
    public sealed class BitrueClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bitrue exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bitrue";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BitrueClient(string division)
            : base(division)
        {
        }
        ...
        public BitrueClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.bitrue.com" },
                                { "private", "https://api.bitrue.com" },
                                { "trade", "https://api.bitrue.com" }
                            },
                            www = "https://www.bitrue.com",
                            doc = new List<string>
                            {
                                "https://docs.bitrue.com"
                            }
                        },
