...
namespace CCXT.NET.IN.modetrade
{
    /// <summary>
    /// Modetrade exchange
    /// </summary>
    public sealed class ModetradeClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Modetrade exchange
        /// </summary>
        public override string DealerName { get; set; } = "Modetrade";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public ModetradeClient(string division)
            : base(division)
        {
        }
        ...
        public ModetradeClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.modetrade.com" },
                                { "private", "https://api.modetrade.com" },
                                { "trade", "https://api.modetrade.com" }
                            },
                            www = "https://www.modetrade.com",
                            doc = new List<string>
                            {
                                "https://docs.modetrade.com"
                            }
                        },
