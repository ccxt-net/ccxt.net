...
namespace CCXT.NET.IN.bitbns
{
    /// <summary>
    /// Bitbns exchange
    /// </summary>
    public sealed class BitbnsClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bitbns exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bitbns";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BitbnsClient(string division)
            : base(division)
        {
        }
        ...
        public BitbnsClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.bitbns.com" },
                                { "private", "https://api.bitbns.com" },
                                { "trade", "https://api.bitbns.com" }
                            },
                            www = "https://www.bitbns.com",
                            doc = new List<string>
                            {
                                "https://docs.bitbns.com"
                            }
                        },
