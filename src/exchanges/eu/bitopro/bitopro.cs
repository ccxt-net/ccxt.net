...
namespace CCXT.NET.EU.bitopro
{
    /// <summary>
    /// Bitopro exchange
    /// </summary>
    public sealed class BitoproClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bitopro exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bitopro";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BitoproClient(string division)
            : base(division)
        {
        }
        ...
        public BitoproClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.bitopro.com" },
                                { "private", "https://api.bitopro.com" },
                                { "trade", "https://api.bitopro.com" }
                            },
                            www = "https://www.bitopro.com",
                            doc = new List<string>
                            {
                                "https://docs.bitopro.com"
                            }
                        },
