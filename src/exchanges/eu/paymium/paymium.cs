...
namespace CCXT.NET.EU.paymium
{
    /// <summary>
    /// Paymium exchange
    /// </summary>
    public sealed class PaymiumClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Paymium exchange
        /// </summary>
        public override string DealerName { get; set; } = "Paymium";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public PaymiumClient(string division)
            : base(division)
        {
        }
        ...
        public PaymiumClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.paymium.com" },
                                { "private", "https://api.paymium.com" },
                                { "trade", "https://api.paymium.com" }
                            },
                            www = "https://www.paymium.com",
                            doc = new List<string>
                            {
                                "https://docs.paymium.com"
                            }
                        },
