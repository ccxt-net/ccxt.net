...
namespace CCXT.NET.EU.onetrading
{
    /// <summary>
    /// Onetrading exchange
    /// </summary>
    public sealed class OnetradingClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Onetrading exchange
        /// </summary>
        public override string DealerName { get; set; } = "Onetrading";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public OnetradingClient(string division)
            : base(division)
        {
        }
        ...
        public OnetradingClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.onetrading.com" }
                            },
                            www = "https://www.onetrading.com",
                            doc = new List<string>
                            {
