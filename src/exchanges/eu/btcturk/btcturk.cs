...
namespace CCXT.NET.EU.btcturk
{
    /// <summary>
    /// Btcturk exchange
    /// </summary>
    public sealed class BtcturkClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Btcturk exchange
        /// </summary>
        public override string DealerName { get; set; } = "Btcturk";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BtcturkClient(string division)
            : base(division)
        {
        }
        ...
        public BtcturkClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.btcturk.com" },
                                { "private", "https://api.btcturk.com" },
                                { "trade", "https://api.btcturk.com" }
                            },
