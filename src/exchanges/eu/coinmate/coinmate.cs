...
namespace CCXT.NET.EU.coinmate
{
    /// <summary>
    /// Coinmate exchange
    /// </summary>
    public sealed class CoinmateClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Coinmate exchange
        /// </summary>
        public override string DealerName { get; set; } = "Coinmate";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CoinmateClient(string division)
            : base(division)
        {
        }
        ...
        public CoinmateClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.coinmate.com" },
                                { "private", "https://api.coinmate.com" },
                                { "trade", "https://api.coinmate.com" }
                            },
                            www = "https://www.coinmate.com",
                            doc = new List<string>
                            {
                                "https://docs.coinmate.com"
                            }
                        },
