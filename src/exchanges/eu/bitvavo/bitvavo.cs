...
namespace CCXT.NET.EU.bitvavo
{
    /// <summary>
    /// Bitvavo exchange
    /// </summary>
    public sealed class BitvavoClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bitvavo exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bitvavo";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BitvavoClient(string division)
            : base(division)
        {
        }
        ...
        public BitvavoClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.bitvavo.com" }
                            },
                            www = "https://www.bitvavo.com",
                            doc = new List<string>
                            {
