...
namespace CCXT.NET.EU.bit2c
{
    ...
    /// Bit2c exchange
    /// </summary>
    public sealed class Bit2cClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bit2c exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bit2c";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public Bit2cClient(string division)
            : base(division)
        {
        }
        ...
        public Bit2cClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.bit2c.com" },
                                { "private", "https://api.bit2c.com" },
                                { "trade", "https://api.bit2c.com" }
                            },
                            www = "https://www.bit2c.com",
                            doc = new List<string>
                            {
                                "https://docs.bit2c.com"
                            }
                        },
