...
namespace CCXT.NET.EU.exmo
{
    /// <summary>
    /// Exmo exchange
    /// </summary>
    public sealed class ExmoClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Exmo exchange
        /// </summary>
        public override string DealerName { get; set; } = "Exmo";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public ExmoClient(string division)
            : base(division)
        {
        }
        ...
        public ExmoClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.exmo.com" }
                            },
                            www = "https://www.exmo.com",
                            doc = new List<string>
                            {
                                "https://docs.exmo.com"
                            }
