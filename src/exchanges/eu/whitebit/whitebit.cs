...
namespace CCXT.NET.EU.whitebit
{
    /// <summary>
    /// Whitebit exchange
    /// </summary>
    public sealed class WhitebitClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Whitebit exchange
        /// </summary>
        public override string DealerName { get; set; } = "Whitebit";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public WhitebitClient(string division)
            : base(division)
        {
        }
        ...
        public WhitebitClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.whitebit.com" },
                                { "private", "https://api.whitebit.com" },
                                { "trade", "https://api.whitebit.com" }
                            },
