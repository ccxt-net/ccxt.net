...
namespace CCXT.NET.EU.btcalpha
{
    /// <summary>
    /// Btcalpha exchange
    /// </summary>
    public sealed class BtcalphaClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Btcalpha exchange
        /// </summary>
        public override string DealerName { get; set; } = "Btcalpha";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BtcalphaClient(string division)
            : base(division)
        {
        }
        ...
        public BtcalphaClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.btcalpha.com" },
                                { "private", "https://api.btcalpha.com" },
                                { "trade", "https://api.btcalpha.com" }
                            },
                            www = "https://www.btcalpha.com",
                            doc = new List<string>
                            {
                                "https://docs.btcalpha.com"
                            }
                        },
