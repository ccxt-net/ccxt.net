...
namespace CCXT.NET.EU.zonda
{
    /// <summary>
    /// Zonda exchange
    /// </summary>
    public sealed class ZondaClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Zonda exchange
        /// </summary>
        public override string DealerName { get; set; } = "Zonda";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public ZondaClient(string division)
            : base(division)
        {
        }
        ...
        public ZondaClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.zonda.com" },
                                { "private", "https://api.zonda.com" },
                                { "trade", "https://api.zonda.com" }
                            },
                            www = "https://www.zonda.com",
                            doc = new List<string>
                            {
                                "https://docs.zonda.com"
                            }
                        },
