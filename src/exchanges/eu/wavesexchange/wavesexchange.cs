...
namespace CCXT.NET.EU.wavesexchange
{
    /// <summary>
    /// Wavesexchange exchange
    /// </summary>
    public sealed class WavesexchangeClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Wavesexchange exchange
        /// </summary>
        public override string DealerName { get; set; } = "Wavesexchange";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public WavesexchangeClient(string division)
            : base(division)
        {
        }
        ...
        public WavesexchangeClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.wavesexchange.com" },
                                { "private", "https://api.wavesexchange.com" },
                                { "trade", "https://api.wavesexchange.com" }
                            },
                            www = "https://www.wavesexchange.com",
                            doc = new List<string>
                            {
                                "https://docs.wavesexchange.com"
                            }
                        },
