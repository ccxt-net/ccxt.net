...
namespace CCXT.NET.JP.zaif
{
    /// <summary>
    /// Zaif exchange
    /// </summary>
    public sealed class ZaifClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Zaif exchange
        /// </summary>
        public override string DealerName { get; set; } = "Zaif";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public ZaifClient(string division)
            : base(division)
        {
        }
        ...
        public ZaifClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.zaif.com" },
                                { "private", "https://api.zaif.com" },
                                { "trade", "https://api.zaif.com" }
                            },
                            www = "https://www.zaif.com",
                            doc = new List<string>
                            {
                                "https://docs.zaif.com"
                            }
