...
namespace CCXT.NET.JP.btcbox
{
    /// <summary>
    /// Btcbox exchange
    /// </summary>
    public sealed class BtcboxClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Btcbox exchange
        /// </summary>
        public override string DealerName { get; set; } = "Btcbox";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BtcboxClient(string division)
            : base(division)
        {
        }
        ...
        public BtcboxClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.btcbox.com" },
                                { "private", "https://api.btcbox.com" },
                                { "trade", "https://api.btcbox.com" }
                            },
                            www = "https://www.btcbox.com",
                            doc = new List<string>
                            {
                                "https://docs.btcbox.com"
                            }
                        },
