...
namespace CCXT.NET.JP.bitbank
{
    /// <summary>
    /// Bitbank exchange
    /// </summary>
    public sealed class BitbankClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Bitbank exchange
        /// </summary>
        public override string DealerName { get; set; } = "Bitbank";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public BitbankClient(string division)
            : base(division)
        {
        }
        ...
        public BitbankClient(string division, string connect_key, string secret_key)
                ...
                if (base.ExchangeInfo == null)
                {
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            {
                                { "public", "https://api.bitbank.com" },
                                { "private", "https://api.bitbank.com" },
                                { "trade", "https://api.bitbank.com" }
                            },
                            www = "https://www.bitbank.com",
                            doc = new List<string>
                            {
                                "https://docs.bitbank.com"
                            }
                        },
