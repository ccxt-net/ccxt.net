...
namespace CCXT.NET.LT.cryptomus
{
    /// <summary>
    /// Cryptomus exchange
    /// </summary>
    public sealed class CryptomusClient : CCXT.NET.Shared.Coin.XApiClient, IXApiClient
    {
        /// <summary>
        /// Cryptomus exchange
        /// </summary>
        public override string DealerName { get; set; } = "Cryptomus";

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="division">exchange's division for communication</param>
        public CryptomusClient(string division)
            : base(division)
        {
        }
        ...
        public CryptomusClient(string division, string connect_key, string secret_key)
                    ...
                    base.ExchangeInfo = new ExchangeInfo(this.DealerName)
                    {
                        ...
                        Urls = new ExchangeUrls
                        {
                            ...
                            api = new Dictionary<string, string>
                            {
                                ...
                                { "trade", "https://api.cryptomus.com" }
                            },
                            www = "https://www.cryptomus.com",
                            doc = new List<string>
                            {
                                "https://docs.cryptomus.com"
                            }
                        },
