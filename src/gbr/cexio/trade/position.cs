...
namespace CCXT.NET.CEXIO.Trade
{
    ...
    ///
    /// </summary>
    public class CMyPositions : CCXT.NET.Shared.Coin.Trade.MyPositions, IMyPositions
    {
        /// <summary>
        ///
        /// </summary>
    ...
    ///
    /// </summary>
    public class CMyPositionItem : CCXT.NET.Shared.Coin.Trade.MyPositionItem, IMyPositionItem
    {
        /// <summary>
        /// User ID
        /// </summary>
