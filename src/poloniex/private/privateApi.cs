...
namespace CCXT.NET.Poloniex.Private
{
    ...
    public class PrivateApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<Dictionary<string, PBalanceItem>> GetBalances()
        {
            ...
            return await UserClient.CallApiPostAsync<Dictionary<string, PBalanceItem>>(__end_point, _params);
        }
        ...
        /// <returns></returns>
        public async Task<IPDepositWithdraw> GetDepositsAndWithdrawals(DateTime start_time, DateTime end_time)
        {
            var _params = new Dictionary<string, object>();
            {
            ...
            return await UserClient.CallApiPostAsync<PDepositWithdraw>(__end_point, _params);
        }
        ...
        /// <returns></returns>
        public async Task<PDepositAddress> GenerateNewDepositAddress(string currency_name)
        {
            var _params = new Dictionary<string, object>();
            {
            ...
            return await UserClient.CallApiPostAsync<PDepositAddress>(__end_point, _params);
        }
        ...
        /// <returns></returns>
        public async Task<PDepositAddress> Withdrawal(string currency_name, decimal amount, string address, string payment_id = null)
        {
            var _params = new Dictionary<string, object>();
            {
