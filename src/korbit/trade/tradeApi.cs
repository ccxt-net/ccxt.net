...
namespace CCXT.NET.Korbit.Trade
{
    ...
    public class TradeApi
    {
        ...
        /// <returns></returns>
        public async Task<KPlaceItem> PlaceLimitBuy(string currency_pair, decimal coin_amount, decimal price, decimal fiat_amount)
        {
            ...
            return await TradeClient.CallApiPostAsync<KPlaceItem>("/v1/user/orders/buy", _params);
        }
        ...
        /// <param name="fiat_amount">코인을 구매하는데 사용하고자 하는 금액(원화). 시장가 주문(type=market)인 경우에만 유효하며, 이 파라미터를 사용할 경우 price 파라미터와 coin_amount 파라미터는 사용할 수 없다.</param>
        /// <returns></returns>
        public async Task<KPlaceItem> PlaceMarketBuy(string currency_pair, decimal coin_amount, decimal price, decimal fiat_amount)
        {
            var _params = new Dictionary<string, object>();
            {
                _params.Add("currency_pair", currency_pair.ToLower());
        ...
        /// <param name="price">비트코인의 가격(원화). 500원 단위로만 가능하다. 지정가 주문(type=limit)인 경우에만 유효하다.</param>
        /// <returns></returns>
        public async Task<KPlaceItem> PlaceLimitSell(string currency_pair, decimal coin_amount, decimal price)
        {
            var _params = new Dictionary<string, object>();
            {
                _params.Add("currency_pair", currency_pair.ToLower());
            ...
            return await TradeClient.CallApiPostAsync<KPlaceItem>("/v1/user/orders/sell", _params);
        }
        ...
        /// <param name="coin_amount">매도하고자 하는 코인의 수량. 지정가 주문인 경우에는 해당 수량을 price 파라미터에 지정한 가격으로 판매하는 주문을 생성한다. 시장가 주문(type=market)인 경우에는 해당 수량을 시장가에 판매하는 주문을 생성하며, 이 경우 price 파라미터는 사용할 수 없다.</param>
        /// <returns></returns>
        public async Task<KPlaceItem> PlaceMarketSell(string currency_pair, decimal coin_amount, decimal price)
        {
            var _params = new Dictionary<string, object>();
            {
                _params.Add("currency_pair", currency_pair.ToLower());
        ...
        /// <returns></returns>
        public async Task<List<KCancel>> CancelOrder(string currency_pair, string order_id)
        {
            var _params = new Dictionary<string, object>();
            {
                _params.Add("currency_pair", currency_pair.ToLower());
            ...
            return await TradeClient.CallApiPostAsync<List<KCancel>>("/v1/user/orders/cancel", _params);
        }
        ...
        /// <returns></returns>
        public async Task<KOpenOrders> OpenOrders(string currency_pair, int offset = 0, int limit = 10)
        {
            var _params = new Dictionary<string, object>();
            {
                _params.Add("currency_pair", currency_pair.ToLower());
            ...
            return await TradeClient.CallApiGetAsync<KOpenOrders>("/v1/user/orders/open", _params);
        }
        ...
        /// <returns></returns>
        public async Task<KOpenOrders> CompleteOrders(string currency_pair, string status, string id, int offset = 0, int limit = 10)
        {
            var _params = new Dictionary<string, object>();
            {
                _params.Add("currency_pair", currency_pair.ToLower());
            ...
            return await TradeClient.CallApiGetAsync<KOpenOrders>("/v1/user/orders", _params);
        }
    }
}